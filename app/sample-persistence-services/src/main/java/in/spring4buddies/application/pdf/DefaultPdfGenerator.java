...
public class DefaultPdfGenerator implements PdfGenerator {
	...
	public void execute() throws Exception {
		...
		document.add(new Chunk("Company Name", PdfFont.HELVETICA_BOLD));
		document.add(Chunk.NEWLINE);

		document.add(new Paragraph("Company address", PdfFont.HELVETICA_NORMAL));
	...
	private static Phrase createPharseText(String text) {
		return new Phrase(text, PdfFont.HELVETICA_NORMAL);
	}
