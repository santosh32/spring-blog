...
DROP TABLE product_class_ref if EXISTS;
DROP TABLE unit_of_measure_ref if EXISTS;
DROP TABLE fulfillment_type_ref if EXISTS;
DROP TABLE node_type_ref if EXISTS;
DROP TABLE inventory_organization_ref if EXISTS;
DROP TABLE store_ref if EXISTS;
DROP TABLE node_group_ref if EXISTS;
DROP TABLE node_fulfillment_type_map if EXISTS;
DROP TABLE node_ref if EXISTS;
DROP TABLE node_group_node_map if EXISTS;
DROP TABLE address_ref if EXISTS;
DROP TABLE day_ref if EXISTS;
DROP TABLE calendar_ref if EXISTS;
DROP TABLE calendar_exception_ref if EXISTS;
DROP TABLE day_of_week_ref if EXISTS;
DROP TABLE shift_ref if EXISTS;
